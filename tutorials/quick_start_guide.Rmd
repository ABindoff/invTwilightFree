...
This function constructs and returns a model which we will fit later using a forward-backward algorithm. It takes a number of necessary parameters and you need to know something about them to use this method successfully, so we will go through them briefly here.
...
fit0 <- SGAT::essie(model,grid,epsilon1=1.0E-4, epsilon2 = 1E-6)
fit <- essierust::essie(model,grid,epsilon1=1.0E-4, epsilon2 = 1E-6)
```
